...
function dealWeb () {
  var headerContent = '<img src="https://creamplay.oss-cn-hangzhou.aliyuncs.com/www/images/logo@2x.png" alt="logo" class="logo" />' +
    ...
    '</div>' +
    '<div class="app">' +
    '<a href="./app.html">稚造APP</a><img src="https://creamplay.oss-cn-hangzhou.aliyuncs.com/www/images/tab-selected.png" alt="selected" />' +
    '</div>' +
    '<div class="about selected">' +
    '<a href="#">关于我们</a><img src="https://creamplay.oss-cn-hangzhou.aliyuncs.com/www/images/tab-selected.png" alt="selected" />' +
    '</div>' +
    '</div>';
  var content = '<img src="https://creamplay.oss-cn-hangzhou.aliyuncs.com/www/images/about.png" alt="about" />' +
    '<div class="footer">' +
    '<div class="footer-border"></div>' +
    '<div class="copyright">Copyright © 2021 Creamplay 保留所有权利。</div>' +
    '<div class="hrefs">' +
