...
$(document).ready(function () {
  ...
  var menuContent = '<div class="nav" style="display:none;"><ul><li><a href="#home">首页</a></li><li><a href="#children">儿童个护</a></li><li><a href="#app">稚造APP</a></li><li><a href="#about">关于我们</a></li></ul></div>';
  if (isApp) {
